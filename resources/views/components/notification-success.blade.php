<div
    ...
    x-init="Livewire.on('ideaWasUpdated', message => {
        showNotification(message)
    })
    ...
    class="flex justify-between max-w-xs sm:max-w-sm w-full z-20 fixed bottom-0 right-0 bg-white rounded-xl shadow-lg border px-6 py-5 mx-6 my-8">
    <div class="flex items-center font-semibold text-gray-500 text-base">
        ...
        <div class="ml-2" x-text="messageToDisplay">
        </div>
    </div>
