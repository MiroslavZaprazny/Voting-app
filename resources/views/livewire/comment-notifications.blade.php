<div wire:poll="getNotificationCount"
            ...
            @if ($notificationCount && !$isLoading)
                ...
                <li class="border-t border-gray-300 text-center">
                    <button 
                        ...
                        @click="isOpen = false"
                        class="w-full block font-semibold hover:bg-gray-100 transition ease-in duration-150 py-4">
                        Mark all as read
                    </button>
                </li>
            @elseif ($isLoading)
                @foreach (range(1, 3) as $item)
                    <li class="animate-pulse flex items-center transition ease-in duration-150 px-5 py-3 ">
                        <div class="bg-gray-200 rounded-full w-10 h-10"></div>
                        <div class="flex-1 ml-4 space-y-2">
                            <div class="bg-gray-200 w-full rounded h-4">
                            </div>
                            <div class="bg-gray-200 w-full rounded h-4">
                            </div>
                            <div class="bg-gray-200 w-1/2 rounded h-4">
                            </div>
                        </div>
                    </li>
                @endforeach
