<div
    class="@if ($comment->is_status_update) is-status-update border border-gray-900{{ 'status-'.Str::kebab($comment->status->name)}}@endif comment-container relative bg-white rounded-xl flex transition duration-500 ease-in mt-4"
>
